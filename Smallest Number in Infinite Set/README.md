<h3><a href=https://leetcode.com/problems/smallest-number-in-infinite-set/?envType=study-plan-v2&envId=leetcode-75>Smallest Number in Infinite Set</a></h3>
<p><p>You have a set which contains all positive integers <code>[1, 2, 3, 4, 5, ...]</code>.</p>
